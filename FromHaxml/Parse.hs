...
import FromHaxml.Lex
import FromHaxml.HuttonMeijerWallace
import Monad hiding (sequence)

{- acooke: recent ghc specific
   for other compilers, try different options
   or use HaXml directly (this was broken by me) -}
